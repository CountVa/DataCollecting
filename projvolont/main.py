...
ex = pd.read_excel('2023-03-09 Registratsiia nauchnykh dokladov na 78 Konferentsiiu studentov asp.xlsx')
...
for i in range(5):
    ...
    document.save(f"{''.join(first_name[i]) +' ' + ''.join(last_name[i])}.docx")
    n += 1
